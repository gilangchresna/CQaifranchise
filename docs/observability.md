...
This document describes the monitoring and observability setup for CyberQuote
MVP, including health checks, dashboard views, alerting thresholds, and metrics
tracking.
...
```bash
cd /Users/Cyberquote/CyberquoteWeb/unified-ai-CQ
